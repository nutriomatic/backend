...
type Product struct {
	...
	PRODUCT_ISSHOW       int64       `gorm:"column:product_isshow" json:"product_isshow"`
	PRODUCT_ENERGI       float64     `json:"product_energi"`
	PRODUCT_GULA         float64     `json:"product_gula"`
	...
	PRODUCT_SATURATEDFAT float64     `gorm:"column:product_saturatedfat" json:"product_saturatedfat"`
	PRODUCT_FIBER        float64     `gorm:"column:product_fiber" json:"product_fiber"`
